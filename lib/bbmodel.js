...
exports.exportPortal = function (rawXml, portalName, destination, exportRaw, onFileCreated) {
    ...
    if (exportRaw) {
        ...
        parseString(rawXml, function (err, parsedXml) {
            var builder = new xml2js.Builder();
            var formattedXml = builder.buildObject(parsedXml);

            writeFile(formattedXml);
        });
    }
};
