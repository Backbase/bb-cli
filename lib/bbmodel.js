...
var listPortals = exports.listPortals = function(callback){
	var req = request({
		...
		method: 'GET',
		url: 'http://localhost:7777/portalserver/portals.xml'
...
var getPortalModel = exports.getPortalModel = function(portal_name, callback){
	request({
		...
		method: 'GET',
		url: 'http://localhost:7777/portalserver/export/portal?portalName=' + portal_name,
	}, function(err, httpResponse, body){
...
var parseContainer = exports.parseContainer = function(container){
	...
	if(!item.properties.property) toDelete.push('properties');
	if(!item.tags.tag) toDelete.push('tags');
