...
(function () {
    ...
    var sortItemsByProperty = function (object, property, property2) {
        var lookupItems = _.reduce(object, function (result, item) {
        ...
        var lookupItems2 = {};
        if (property2) {
            lookupItems2 = _.reduce(object, function (result, item) {
        ...
        try {
            return _.sortBy(object, function (a, b) {
                var da, db, da2, db2;
