    ...
    var processItems = function () {
        ...
        function getDifferences(localItemPackage, remoteItemPackage) {
            ...
            if (!isEqual) {
                ...
                if (difference.properties && difference.properties.property.length === 0
        ...
        function sanitizeItem(item) {
            ...
            var fieldWhitelist = ['name',
                                    ...
                                    'properties',
                                    'tags',
                                    'type'];// Only for templates, but not validating item type here
