            ...
            return bbrest[bbRestType]()
                ...
                .then(function (postResponseData) {
                    switch (postResponseData.statusCode) {
                        ...
                        case 400:
                        case 404:
                            console.log('Post Error..', postResponseData.statusCode, ':', localItem.name, ' - ', parseResponseToString(postResponseData.body));
                            break;
                        default:
                            console.log('Post DefaultError..', postResponseData.statusCode, ':', localItem.name, ' - ', parseResponseToString(postResponseData.body));
                    }
                })
                .fail(function (e) {
                    console.log('failed pre-post..', e);
