...
exports.getCommon = function(cliConfig) {
    ...
    .then(function(config) {
        bbrest = new BBRest();
        bbrest.config = {
            host: config.bbrc.host || bbrest.config.host,
            port: config.bbrc.port || bbrest.config.port,
            context: config.bbrc.context || bbrest.config.context,
            username: config.bbrc.username || bbrest.config.username,
            password: config.bbrc.password || bbrest.config.password,
            portal: config.bbrc.portal || bbrest.config.portal,
